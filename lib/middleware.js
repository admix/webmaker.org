...
module.exports.addCSP = function(options) {
  return hood.csp({
    ...
    policy: {
      ...
      'script-src': ["'self'", "https://ssl.google-analytics.com","https://mozorg.cdn.mozilla.net/en-US/tabzilla/tabzilla.js","https://mozorg.cdn.mozilla.net/tabzilla/tabzilla.js"],
      'style-src': ["'self'","http://mozorg.cdn.mozilla.net/media/css/tabzilla-min.css","http://localhost:3000/css/nav.css"]//, "'unsafe-inline'"]
    }
  });
};
